...
function insertInlineStyles() {
	...
	styleTag.textContent = `.icon-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:20px}.style-block{background-color:#f5f5f5}.style-block>div{text-align:center;margin-bottom:2rem}.style-block h3{text-align:center;margin:2rem 0!important}.style-block p{text-align:center;font-size:1.4rem;font-family:Lato,sans-serif}`;

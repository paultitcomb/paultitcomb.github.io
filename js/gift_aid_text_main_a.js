...
STCUK.donatePod = {
	...
	launchGiftAidTooltip: function (e) {
		...
		var $activePanel = thisComponent.getPanelState().activePanel;
		var $overlayPanel = thisComponent.getActiveDonateMethodOverlay($activePanel);
		var $giftAidPanel = $overlayPanel.querySelector('.gift-aid-explanation');
		$giftAidPanel.classList.add('open');
	},
